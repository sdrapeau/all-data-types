 ...
 * </p>
 * <ul>
 *   <li>{@link alldatatypes.impl.RootImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RootImpl extends ElementImpl implements Root {
	...
	protected EClass eStaticClass() {
		return AlldatatypesPackage.Literals.ROOT;
	}
	...
	public EList<Type> getTypes() {
		if (types == null) {
			types = new EObjectContainmentEList<Type>(Type.class, this, AlldatatypesPackage.ROOT__TYPES);
		}
		return types;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case AlldatatypesPackage.ROOT___GET_ALL_TYPES:
				return getAllTypes();
		}
